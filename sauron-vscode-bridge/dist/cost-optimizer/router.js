...
function pickConfiguredAgent(matrix, preferredOrder, requireWallet = true) {
...
function resolvePreferredAgentId(hint, matrix, options) {
...
function resolveClineAgent(complexityHint, agentMatrix, options = {}) {
