...
exports.buildDefaultCostOptimizerConfig = buildDefaultCostOptimizerConfig;
exports.mergeCostOptimizerConfig = mergeCostOptimizerConfig;
...
function mergeCostOptimizerConfig(raw) {
    ...
    const coreModelTier = parsed.coreModelTier === "standard" ||
    ...
    if (parsed.models && typeof parsed.models === "object") {
        for (const tier of Object.keys(defaults.models)) {
            const normalized = normalizeTierModel(parsed.models[tier]);
            if (normalized) {
    ...
    const routing = parsed.routing && typeof parsed.routing === "object"
        ? parsed.routing
        : {};
    const budgetGovernor = parsed.budgetGovernor && typeof parsed.budgetGovernor === "object"
        ? parsed.budgetGovernor
        : {};
    return {
        ...
        agentMatrix: parsed.agentMatrix && typeof parsed.agentMatrix === "object"
            ? parsed.agentMatrix
            : undefined,
    };
}
