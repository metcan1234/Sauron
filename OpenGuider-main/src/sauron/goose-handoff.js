...
function writeGooseHandoff(workspacePath, { taskText, mode, sessionId, tokenUltra = null, deltaFrom = null, compressedSummary = "" } = {}) {
  ...
  const handoff = {
    ...
    tokenUltra: tokenUltra || {
      channel: "goose",
      deltaFrom: deltaFrom || null,
      compressedSummary: String(compressedSummary || "").trim() || undefined,
    },
  };
